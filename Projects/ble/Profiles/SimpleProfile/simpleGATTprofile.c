...
static uint8 simpleProfileChar1UserDesp[7] = "Dev ID\0";
...
static uint8 simpleProfileChar4UserDesp[] = "Device Output\0";
...
static uint8 simpleProfileChar5UserDesp[] = "Device In\0";
       ...
       case SIMPLEPROFILE_CHAR5_UUID:
         {
           ...
           if ( status == SUCCESS )
           {
             uint8 *pCurValue = (uint8 *)pAttr->pValue;        
             *pCurValue = pValue[0];
             VOID osal_memcpy( pCurValue, pValue, SIMPLEPROFILE_CHAR5_LEN );
